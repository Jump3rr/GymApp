...
const CalculatorBMR = () => {
    ...
    const calculateBmr = (age: number, height: any, weight: any, heightInches?: any) => {
        setTextResult('');
        ...
        <View style={styles.main}>
            ...
            {unit === 'eu' && (
                <>
                    ...
                    <TouchableOpacity style={styles.button} onPress={() => calculateBmr(age, height, weight)}>
                        <Text>Calculate</Text>
                    </TouchableOpacity>
                </>
            )}
            {unit === 'us' && (
                <>
                    ...
                    <TouchableOpacity style={styles.button} onPress={() => calculateBmr(age, height, weight, heightInches)}>
                        <Text>Calculate</Text>
                    </TouchableOpacity>
                </>
            )}
